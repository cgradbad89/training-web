...
src/
  ...
  utils/            # Domain logic: metrics, pace, dates, trainingLoad, riegelFit, etc.
    __tests__/      # Vitest tests (full suite: 1,480 tests across 138 files)
```
