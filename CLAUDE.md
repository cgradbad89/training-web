...
src/
  ...
  utils/            # Domain logic: metrics, pace, dates, trainingLoad, riegelFit, etc.
    __tests__/      # Vitest tests (full suite: 1,606 tests across 150 files)
```
