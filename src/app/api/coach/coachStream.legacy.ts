// Transitional rollback path. This module is intentionally not imported by the
// active Coach route and can be removed after production Gateway verification.
